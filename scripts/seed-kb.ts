...
async function main() {
  ...
  const teamData = [
    ...
    },
    {
      slug: "kylian",
      fullName: "Kylian",
      promptLabel: "Kylian (Senior Dev Laravel — fonctionnalités complexes)",
      role: "Senior Dev",
      specialties: ["Laravel", "Full-stack", "Fonctionnalités métier complexes"],
    ...
    },
    {
      slug: "peter",
      fullName: "Peter",
      promptLabel: "Peter (Intégration + QA — tests, recettes, volume)",
      role: "Dev intégration + QA",
      specialties: ["Intégration", "QA", "Tests Pest", "Recettes"],
