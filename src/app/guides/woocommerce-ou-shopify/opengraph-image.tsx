...
export const alt =
  "WooCommerce ou Shopify : que choisir en 2026 ? — Hagnéré Code";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", fontSize: 30, color: "#a1a1aa" }}>
          Comparez l’entretien, les coûts et la liberté selon votre activité
        </div>
      </div>

      <div style={{ display: "flex", gap: 14 }}>
        {["Entretien", "Coûts", "Liberté et autonomie"].map((t) => (
          <div
            key={t}
            style={{
              display: "flex",
