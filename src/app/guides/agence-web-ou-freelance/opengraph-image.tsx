...
export const alt =
  "Agence web ou freelance : qui choisir pour votre projet ? — Hagnéré Code";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", fontSize: 30, color: "#a1a1aa" }}>
          Comparez les personnes, le prix, le délai et le contrat
        </div>
      </div>

      <div style={{ display: "flex", gap: 14 }}>
        {[
          "Travail réellement prévu",
          "Continuité du service",
          "Code et comptes récupérables",
        ].map((t) => (
          <div
            key={t}
            style={{
