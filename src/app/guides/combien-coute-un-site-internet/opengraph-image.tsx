...
export const alt = "Combien coûte un site internet en 2026 ? — Hagnéré Code";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", fontSize: 30, color: "#a1a1aa" }}>
          Budget de départ et coûts pendant trois ans
        </div>
      </div>

      <div style={{ display: "flex", gap: 14 }}>
        {[
          "Site simple ou vitrine",
          "Boutique ou application",
          "Comprendre le devis",
        ].map((t) => (
          <div
            key={t}
