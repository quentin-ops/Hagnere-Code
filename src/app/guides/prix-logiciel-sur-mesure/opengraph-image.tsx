...
export const alt =
  "Combien coûte un logiciel sur mesure en 2026 ? — Hagnéré Code";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", fontSize: 30, color: "#a1a1aa" }}>
          Fourchettes de prix, solutions possibles et devis expliqués
        </div>
      </div>

      <div style={{ display: "flex", gap: 14 }}>
        {[
          "Fourchettes par projet",
          "Abonnement ou sur mesure",
          "Comparer deux devis",
        ].map((t) => (
          <div
            key={t}
