...
export const alt =
  "Faut-il migrer votre site WordPress vers Next.js ? — Hagnéré Code";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", fontSize: 30, color: "#a1a1aa" }}>
          Réparer, mieux héberger ou reconstruire ?
        </div>
      </div>

      <div style={{ display: "flex", gap: 14 }}>
        {[
          "Quatre solutions comparées",
          "Prix et risques SEO",
          "Quand conserver WordPress",
        ].map((t) => (
          <div
            key={t}
            style={{
