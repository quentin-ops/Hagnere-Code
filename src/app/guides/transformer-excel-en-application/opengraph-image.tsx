    ...
    (
      <div
        style={{
          ...
          padding: 68,
          background: "linear-gradient(135deg, #09090b 0%, #111827 52%, #24103f 100%)",
          color: "#fff",
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", flex: 1, gap: 18 }}>
            ...
            <div style={{ display: "flex", fontSize: 27, color: "#a1a1aa" }}>
              Garder · acheter · prototyper · développer
            </div>
          </div>
          ...
          >
            <div style={{ display: "flex", height: 42, background: "#166534", alignItems: "center", padding: "0 16px", fontSize: 17, fontWeight: 700 }}>
              EXCEL → APP
            </div>
            {["Données", "Règles métier", "Droits", "Historique"].map((label, index) => (
              <div
                key={label}
                style={{
                  display: "flex",
        ...
        <div style={{ display: "flex", gap: 12 }}>
          {["Diagnostic sans email", "Coût sur 4 ans", "Plan de migration", "Clauses à exiger"].map((label) => (
            <div
              key={label}
              style={{
                display: "flex",
