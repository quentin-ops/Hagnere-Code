...
export const alt =
  "Combien de temps faut-il pour créer un site internet ? — Hagnéré Code";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", fontSize: 30, color: "#a1a1aa" }}>
          Délais, préparation et validations à organiser
        </div>
      </div>

      <div style={{ display: "flex", gap: 14 }}>
        {[
          "Vitrine, boutique ou outil",
          "Contenus à préparer",
          "Tenir une date importante",
        ].map((t) => (
          <div
            key={t}
            style={{
