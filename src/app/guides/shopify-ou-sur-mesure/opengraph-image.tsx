...
export const alt =
  "Shopify ou boutique sur mesure : lequel choisir pour votre entreprise ?";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", fontSize: 30, color: "#a1a1aa" }}>
          Boutique classique ou règles de vente particulières ?
        </div>
      </div>

      <div style={{ display: "flex", gap: 14 }}>
        {["Besoin réel", "Coût sur 3 ans", "Possibilité de changer"].map(
          (t) => (
            <div
              key={t}
              style={{
