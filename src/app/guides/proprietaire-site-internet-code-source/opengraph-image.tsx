...
export const alt =
  "Qui est propriétaire de votre site et de son code source ? — Hagnéré Code";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ display: "flex", fontSize: 30, color: "#a1a1aa" }}>
            Payer ne transfère aucun droit — et après ?
          </div>
        </div>
        ...
        <div style={{ display: "flex", gap: 14 }}>
          {[
            ...
            "Les 14 accès à réclamer",
            "Le modèle de clause L131-3",
          ].map((t) => (
            <div
              key={t}
              style={{
