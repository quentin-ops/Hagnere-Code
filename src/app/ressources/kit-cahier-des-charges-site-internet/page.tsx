...
export default function Page() {
  ...
  return (
    <GuidesShell>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: webPageJsonLd.replace(/</g, "\\u003c") }} />
        ...
        <div className="mx-auto max-w-5xl px-4">
          <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-6 sm:p-8 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <p className="mt-5 text-xs leading-relaxed text-zinc-600 dark:text-zinc-400">
              Ces contrôles ne constituent ni une certification d&apos;accessibilité,
              ni un test natif sur toutes les versions de Microsoft Word et
              Excel. Les formats OOXML visent leurs versions récentes.
            </p>
          </div>
        </div>
      </section>
