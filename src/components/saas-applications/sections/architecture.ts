...
<section class="sa-arch">
  <div class="wrap">
    ...
    <div class="sa-arch-diagram reveal">
    ...
    <div class="sa-arch-caption reveal">
      <div class="sa-arch-caption-k">
        <span><span class="sa-arch-dot" style="background:#6D28D9"></span> Cœur de la stack</span>
        <span><span class="sa-arch-dot" style="background:#404040"></span> Composants maîtrisés</span>
        <span><span class="sa-arch-dot" style="background:rgba(255,255,255,0.2)"></span> Services externes</span>
      </div>
      <p>
