  ...
  <div class="wrap">
    <div class="faq-grid">
      ...
      <div class="faq-list reveal reveal-d-1">
        ...
        <h3 class="faq-subhead eyebrow">— Pour les profils techniques</h3>
        <!-- Réserve rapatriée de la section technique fusionnée : sans elle,
             les huit réponses ci-dessous se lisent comme des engagements alors
             qu'elles décrivent une méthode. -->
        <p class="faq-subnote">Les réponses ci-dessous décrivent notre méthode&nbsp;; les choix finaux dépendent du contexte.</p>
