    ...
    <div class="cv-check-grid">
      ...
      <div class="cv-check-col cv-check-col-out reveal reveal-d-1">
        ...
        <ul class="cv-check-list">
          ...
          <li><div class="cv-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div><div><b>Location studio externe</b> — notre studio de Bassens suffit à 90 %. Au-delà, refacturation.</div></li>
