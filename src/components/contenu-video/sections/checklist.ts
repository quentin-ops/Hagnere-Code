...
<section class="cv-check">
  <div class="wrap">
    <div class="section-head reveal">
      <div class="left">
        <div class="eyebrow">— Grille de cadrage</div>
        <h2>Rendre chaque livrable<br>vérifiable au devis.</h2>
      </div>
      <div class="right">
        Les lignes ci-dessous sont des sujets à arbitrer, pas un socle inclus dans toutes les missions.
      </div>
    </div>
    ...
    <div class="cv-check-grid">
      ...
      <div class="cv-check-col reveal">
        ...
        <ul class="cv-check-list">
          ...
          <li><div class="cv-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div><div><b>Montage humain identifié</b> — outil, responsable et niveau d'expérience précisés.</div></li>
          ...
          <li><div class="cv-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div><div><b>Révisions cadrées</b> — nombre de tours, changements inclus, micro-ajustements et validation finale précisés au devis.</div></li>
          <li><div class="cv-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div><div><b>Musique &amp; banque de sons</b> — licences Artgrid / Epidemic Sound précisées et portées au devis.</div></li>
          <li><div class="cv-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div><div><b>Rushs et sources</b> — liste, formats et droits précisés ; transfert après paiement complet.</div></li>
      ...
      <div class="cv-check-col cv-check-col-out reveal reveal-d-1">
        ...
        <ul class="cv-check-list">
          ...
          <li><div class="cv-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div><div><b>Lieu et matériel de tournage</b> — à chiffrer explicitement ; aucun studio permanent n'est présumé.</div></li>
