...
<section class="sr-check">
  <div class="wrap">
    <div class="section-head reveal">
      ...
      <div class="right">
        Voici ce qui rentre dans le forfait cadrage + abonnement DPO. Et ce qui n'y rentre pas (plutôt que de
        le découvrir à J+30 sur une facture surprise).
      </div>
    </div>
    ...
    <div class="sr-check-grid">
      ...
      <div class="sr-check-col reveal">
        ...
        <h3>Tout ce qui rend la conformité<br>défendable et opérationnelle.</h3>
        <ul class="sr-check-list">
          ...
          <li><div class="sr-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div><div><b>AIPD incluses</b> — 1 à 4 analyses d'impact selon formule, sur traitements à risque (recrutement IA, scoring, biométrie).</div></li>
          ...
          <li><div class="sr-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div><div><b>Classification AI Act</b> — chaque système IA classé Annexe II/III, doc technique Article 11.</div></li>
          ...
          <li><div class="sr-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div><div><b>Slack dédié + SLA 4 h ouvrées</b> — sur tout incident bloquant ou demande CNIL urgente.</div></li>
        </ul>
      </div>
      ...
      <div class="sr-check-col sr-check-col-out reveal reveal-d-1">
        ...
        <ul class="sr-check-list">
          <li><div class="sr-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div><div><b>Pen-test offensif lourd PASSI</b> — sous-traité à un partenaire qualifié ANSSI, refacturé.</div></li>
          ...
          <li><div class="sr-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div><div><b>Certification ISO 27001 finale</b> — l'audit certifiant est mené par AFNOR / Bureau Veritas. On vous met en condition (12-16 sem.) puis on présente avec vous.</div></li>
          <li><div class="sr-check-ic"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div><div><b>Audit SOC 2 Type II final</b> — l'attestation est délivrée par un cabinet CPA (Drata, Vanta, ou cabinet US). On prépare, on présente, ils valident.</div></li>
