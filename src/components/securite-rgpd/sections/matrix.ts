export const matrixHtml = `
<!-- MATRICE · 4 domaines couverts -->
<section class="sr-matrix" id="offre">
  <div class="wrap">
    ...
    <div class="sr-matrix-grid">

      <!-- 01 RGPD -->
      <article class="sr-matrix-card reveal">
      ...
      <article class="sr-matrix-card sr-matrix-card-featured reveal reveal-d-1">
        ...
        <div class="sr-matrix-head">
          ...
          <div class="sr-matrix-title">
            <div class="sr-matrix-kind">AI Act EU</div>
            <h3>Classifier, documenter, défendre.</h3>
          </div>
          <div class="sr-matrix-ic sr-matrix-ic-ai">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
      ...
      <!-- 03 Cyber audit -->
      <article class="sr-matrix-card reveal reveal-d-2">
        <div class="sr-matrix-head">
          <div class="sr-matrix-num">03</div>
          <div class="sr-matrix-title">
            <div class="sr-matrix-kind">Cyber audit applicatif</div>
            <h3>Code, infra, CI, IAM.</h3>
          </div>
          <div class="sr-matrix-ic sr-matrix-ic-cyber">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
        ...
        <ul class="sr-matrix-feats">
          ...
          <li><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg>Pipeline SAST/DAST/SCA en GitHub Actions</li>
    ...
    <div class="sr-matrix-note reveal">
