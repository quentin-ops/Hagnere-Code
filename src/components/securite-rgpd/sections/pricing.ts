...
<section class="sr-pricing" id="tarifs">
  <div class="wrap">
    ...
    <div class="sr-price-grid">
      ...
      <div class="sr-price-card reveal">
        ...
        <ul class="sr-price-feats">
          ...
          <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg>Écarts techniques et documentaires à qualifier</li>
      ...
      <div class="sr-price-card reveal reveal-d-1">
        ...
        <ul class="sr-price-feats">
          ...
          <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg>Preuves techniques pour l'AIPD pilotée par votre DPO</li>
          <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg>Suivi du plan de remédiation validé</li>
      ...
      <div class="sr-price-card sr-price-card-featured reveal reveal-d-2">
        ...
        <ul class="sr-price-feats">
          ...
          <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg>Preuves techniques pour les AIPD pilotées par votre DPO</li>
    ...
    <p class="sr-price-foot">
      ...
      livrables, exclusions, durée, niveaux de service et conditions de réversibilité. Ces prestations
