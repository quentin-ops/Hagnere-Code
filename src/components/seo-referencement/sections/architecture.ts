...
<section class="seo-arch">
  <div class="wrap">
    ...
    <div class="seo-arch-diagram reveal">
    ...
    <div class="seo-arch-caption reveal">
      <div class="seo-arch-caption-k">
        <span><span class="seo-arch-dot" style="background:#6D28D9"></span> Cœur de la stack</span>
        <span><span class="seo-arch-dot" style="background:#404040"></span> Composants maîtrisés</span>
        <span><span class="seo-arch-dot" style="background:rgba(255,255,255,0.2)"></span> Services externes</span>
      </div>
      <p>
