    ...
    <div class="seo-testi-grid">
      <article class="seo-testi-card reveal">
        ...
        <div class="seo-testi-meta">
          ...
          <div class="seo-testi-who">
            <div class="seo-testi-name">Référence anonymisée</div>
            <div class="seo-testi-role">Founder · site B2B · <b>MVP livré en 5 semaines</b></div>
          </div>
        </div>
      </article>
      ...
      <article class="seo-testi-card reveal reveal-d-1">
        ...
        <div class="seo-testi-meta">
          ...
          <div class="seo-testi-who">
            <div class="seo-testi-name">Référence anonymisée</div>
            <div class="seo-testi-role">CEO · site B2B · <b>Refonte 60 k€ forfait</b></div>
          </div>
        </div>
      </article>
      ...
      <article class="seo-testi-card reveal reveal-d-2">
        ...
        <div class="seo-testi-meta">
          ...
          <div class="seo-testi-who">
            <div class="seo-testi-name">Référence anonymisée</div>
            <div class="seo-testi-role">CTO · site B2B · <b>Agents IA intégrés en 4 sem.</b></div>
          </div>
        </div>
      </article>
    </div>
