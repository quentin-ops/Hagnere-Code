...
<section class="seo-check">
  <div class="wrap">
    ...
    <div class="seo-check-grid">
      <!-- INCLUS -->
      <div class="seo-check-col seo-check-in reveal">
        <div class="seo-check-head">
          <div class="seo-check-badge seo-check-badge-in">
        ...
        <ul class="seo-check-list">
          <li>
            <div class="seo-check-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div>
          ...
          <li>
            <div class="seo-check-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div>
            <div><b>Permissions Netlinking white-hat (RP, partenariats)</b> — équipes, rôles, droits par ressource, délégation, audit log horodaté.</div>
          </li>
          <li>
            <div class="seo-check-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg></div>
      ...
      <!-- HORS SCOPE -->
      <div class="seo-check-col seo-check-out reveal reveal-d-1">
        <div class="seo-check-head">
          <div class="seo-check-badge seo-check-badge-out">
        ...
        <ul class="seo-check-list seo-check-list-out">
          <li>
            <div class="seo-check-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div>
