...
<div class="wrap">
  <div class="crumb">
    ...
    <span class="sep">/</span>
    <span style="color:var(--ink-3)">SEO &amp; référencement Google</span>
  </div>
</div>
  ...
  <div class="wrap shero-inner">
    <div>
      ...
      <div class="shero-tagline">
        ...
        <span class="sep"></span>
        <span>🎯 KPIs business, pas vanity</span>
        <span class="sep"></span>
        <span>🛡️ Résilient aux updates</span>
      </div>
      <p class="shero-sub">
        Un accompagnement SEO qui <b>transforme votre site en canal d'acquisition #1</b> — audit technique,
        cocons sémantiques, contenu éditorial et netlinking qualitatif, tout piloté par un consultant
        senior dédié. <b>Vous arrêtez quand vous voulez après 3 mois</b>, vous gardez tous les livrables.
      </p>
      <div class="shero-cta">
        <a href="#contact" class="btn btn-accent btn-lg">
          Cadrer ma stratégie SEO <svg class="arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 5l7 7-7 7"/></svg>
        </a>
        <a href="#contact" class="btn btn-ghost btn-lg">Audit SEO offert · 30 min</a>
      </div>
      <div class="shero-meta">
        <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg> Consultant senior dédié</span>
        <span class="sep"></span>
        <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12l5 5L20 7"/></svg> Reporting business mensuel</span>
        <span class="sep"></span>
    ...
    <div class="shero-visual">
      <div class="mock-window mw-main">
        <div class="win-chrome">
          ...
          <div class="win-url">search.google.com/search-console · 12 mois</div>
        </div>
        <svg width="100%" viewBox="0 0 540 360" style="display:block">
          ...
          <circle cx="30" cy="22" r="10" fill="#4285F4"/>
          <text x="46" y="27" font-family="Geist" font-weight="700" font-size="13" fill="#0A0A0A">Performance</text>
          <rect x="426" y="12" width="96" height="20" rx="4" fill="#EDE9FE"/>
          <text x="474" y="26" text-anchor="middle" font-family="Geist Mono" font-size="9" font-weight="700" fill="#6D28D9">12 MOIS</text>
          <g transform="translate(24 64)">
            <rect x="0" y="0" width="152" height="68" rx="10" fill="#F5F5F5"/>
            <text x="14" y="22" font-family="Geist Mono" font-size="8" fill="#737373" letter-spacing="1">CLICS</text>
            <text x="14" y="52" font-family="Geist" font-weight="700" font-size="22" fill="#0A0A0A">147 k</text>
            <text x="88" y="52" font-family="Geist Mono" font-size="10" font-weight="700" fill="#22C55E">+ 187 %</text>
            <rect x="164" y="0" width="152" height="68" rx="10" fill="#EDE9FE"/>
            <text x="178" y="22" font-family="Geist Mono" font-size="8" fill="#4C1D95" letter-spacing="1">IMPRESSIONS</text>
            <text x="178" y="52" font-family="Geist" font-weight="700" font-size="22" fill="#0A0A0A">2,86 M</text>
            <text x="262" y="52" font-family="Geist Mono" font-size="10" font-weight="700" fill="#22C55E">+ 212 %</text>
            <rect x="328" y="0" width="164" height="68" rx="10" fill="#0A0A0A"/>
            <text x="342" y="22" font-family="Geist Mono" font-size="8" fill="#737373" letter-spacing="1">POSITION MOYENNE</text>
            <text x="342" y="52" font-family="Geist" font-weight="700" font-size="22" fill="#fff">8,4</text>
            <text x="388" y="52" font-family="Geist Mono" font-size="10" font-weight="700" fill="#22C55E">↑ 19,2</text>
          </g>
          <rect x="24" y="150" width="492" height="188" rx="10" fill="#fff" stroke="#E5E5E5"/>
          <text x="40" y="172" font-family="Geist Mono" font-size="9" fill="#737373" letter-spacing="1">CLICS ORGANIQUES · ÉVOLUTION 12 MOIS</text>
          <line x1="40" y1="196" x2="500" y2="196" stroke="#f0f0f0" stroke-dasharray="2 3"/>
          <line x1="40" y1="232" x2="500" y2="232" stroke="#f0f0f0" stroke-dasharray="2 3"/>
          <line x1="40" y1="268" x2="500" y2="268" stroke="#f0f0f0" stroke-dasharray="2 3"/>
          <line x1="40" y1="304" x2="500" y2="304" stroke="#f0f0f0" stroke-dasharray="2 3"/>
          <line x1="160" y1="186" x2="160" y2="316" stroke="#6D28D9" stroke-dasharray="4 3" stroke-width="1"/>
          <text x="84" y="198" font-family="Geist Mono" font-size="8" fill="#a3a3a3" letter-spacing="1">AVANT</text>
          <text x="180" y="198" font-family="Geist Mono" font-size="8" fill="#6D28D9" font-weight="600" letter-spacing="1">— ACCOMPAGNEMENT HAGNÉRÉ —</text>
          <path d="M40 300 L68 298 L96 296 L124 292 L152 290 L160 288 L188 278 L216 260 L244 240 L272 218 L300 196 L328 178 L356 164 L384 158 L412 148 L440 142 L468 136 L496 130 L496 316 L40 316 Z" fill="#6D28D9" opacity="0.12"/>
          <path d="M40 300 L68 298 L96 296 L124 292 L152 290 L160 288 L188 278 L216 260 L244 240 L272 218 L300 196 L328 178 L356 164 L384 158 L412 148 L440 142 L468 136 L496 130" fill="none" stroke="#6D28D9" stroke-width="2.2" stroke-linejoin="round"/>
          <circle cx="496" cy="130" r="4" fill="#6D28D9"/>
          <circle cx="496" cy="130" r="9" fill="none" stroke="#6D28D9" stroke-width="1" opacity="0.4"/>
          <text x="40" y="332" font-family="Geist Mono" font-size="8" fill="#a3a3a3">Jan</text>
          <text x="216" y="332" font-family="Geist Mono" font-size="8" fill="#a3a3a3">Jun</text>
          <text x="496" y="332" font-family="Geist Mono" font-size="8" fill="#6D28D9" font-weight="600" text-anchor="end">Déc</text>
        </svg>        </svg>
      </div>
      ...
      <div class="mock-window mw-side">
        <div class="win-chrome" style="background:#0d0d0d;border-color:rgba(255,255,255,0.08)">
          <div class="win-dots"><span></span><span></span><span></span></div>
          <div class="win-url" style="color:rgba(255,255,255,0.5)">Ahrefs · Organic keywords · top 10</div>
        </div>
        <div style="padding:18px 20px 16px;background:#0A0A0A;color:#E5E5E5;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;line-height:1.4">
          <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:12px">
            <div>
              <div style="font-family:'Geist Mono';font-size:9px;color:#737373;letter-spacing:0.12em">POSITIONS GAGNÉES</div>
              <div style="font-size:20px;font-weight:700;color:#fff;margin-top:4px">+ 412 mots-clés</div>
            </div>
            <div style="font-family:'Geist Mono';font-size:10px;color:#22C55E;font-weight:700">en top 10</div>
          </div>
          <div style="display:flex;flex-direction:column;gap:8px;padding-top:12px;border-top:1px solid rgba(255,255,255,0.08)">
            <div style="display:flex;justify-content:space-between;font-size:11px"><span style="color:#a3a3a3">logiciel gestion PME</span><span style="font-family:'Geist Mono';color:#22C55E;font-weight:700">#2</span></div>
            <div style="display:flex;justify-content:space-between;font-size:11px"><span style="color:#a3a3a3">outil comptable en ligne</span><span style="font-family:'Geist Mono';color:#22C55E;font-weight:700">#3</span></div>
            <div style="display:flex;justify-content:space-between;font-size:11px"><span style="color:#a3a3a3">ERP petite entreprise</span><span style="font-family:'Geist Mono';color:#22C55E;font-weight:700">#5</span></div>
            <div style="display:flex;justify-content:space-between;font-size:11px"><span style="color:#a3a3a3">facturation automatique</span><span style="font-family:'Geist Mono';color:#F59E0B;font-weight:700">#8</span></div>
            <div style="display:flex;justify-content:space-between;font-size:11px"><span style="color:#a3a3a3">CRM sur mesure PME</span><span style="font-family:'Geist Mono';color:#F59E0B;font-weight:700">#11 → #6</span></div>
          </div>
        </div>
      </div>
    </div>
