...
// (verrouillés par logo-wall-qualification.test.ts) : sans eux, quatre logos
...
<!-- PRODUCT LOGO WALL -->
<section class="ec-clients-wall" aria-label="Les quatre produits du groupe Hagnéré">
  <div class="wrap">
    <div class="ec-cw-kicker">— Les quatre produits du groupe Hagnéré, en ligne</div>
    ...
    <div class="ec-cw-foot">
      <span><span class="ec-cw-dot"></span> Ce sont des <b>produits du groupe Hagnéré</b>, pas des clients indépendants. Les <b>4 pages</b> permettent de vérifier leur disponibilité et leurs fonctions visibles, pas leur conception, leur exploitation, leur audience ni leurs résultats.</span>
    </div>
  </div>
</section>
`;
