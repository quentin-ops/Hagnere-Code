...
<!-- CE QU'ON REFUSE -->
<section class="ec-refuse">
  <div class="wrap">
    <div class="ec-refuse-grid">
      <div class="ec-refuse-intro reveal">
        <div class="eyebrow">— Les projets qu'on décline</div>
        <h2>Certains projets e-com<br>ne sont pas pour nous.</h2>
        <p>
          On ne filtre pas sur le secteur — on filtre sur la <b>faisabilité, la légalité et la santé du projet</b>.
          Si votre dossier coche l'une des cases ci-contre, on déclinera franchement, quelle que soit la taille
          du budget.
        </p>
        <div class="ec-refuse-foot">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
          Dire non à certains projets permet de préserver l'attention et la qualité de ceux que l'on accepte.
        </div>
      </div>

      <ul class="ec-refuse-list reveal reveal-d-1">
        <li>
