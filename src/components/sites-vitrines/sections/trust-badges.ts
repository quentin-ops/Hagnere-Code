  ...
  <div class="wrap">
    ...
    <div class="sv-trust-grid">
      <div class="sv-trust-card reveal">
        ...
        <div class="sv-trust-foot">— Dossier type fourni à la livraison</div>
      </div>
      ...
      <div class="sv-trust-card reveal">
        ...
        <div class="sv-trust-foot">— SLA 4 h ouvrées sur bugs bloquants</div>
      </div>
      ...
      <div class="sv-trust-card reveal reveal-d-3">
        ...
        <div class="sv-trust-foot">— Prise en charge partielle fréquente</div>
      </div>
    </div>
  </div>
</section>
