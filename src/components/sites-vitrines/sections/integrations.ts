...
<!-- INTEGRATIONS WALL (segmenté par usage site vitrine) -->
<section class="sv-integ">
  <div class="wrap">
    <div class="section-head reveal">
      <div class="left">
        <div class="eyebrow">— Intégrations standards</div>
        <h2>Tous les outils qu'on branche<br>avant même de les demander.</h2>
      </div>
      <div class="right">
        Un site vitrine efficace se branche à votre CRM, vos analytics et vos outils
        marketing. Voici ce qu'on sait intégrer <b>proprement et vite</b>, segmenté par
        usage — le reste, on l'apprend en un sprint si l'API est standard.
      </div>
    </div>
    ...
    <div class="sv-integ-grid">
      <div class="sv-integ-group reveal">
        <div class="sv-integ-head">
          ...
          <div>
            <div class="sv-integ-kind">FORMULAIRES &amp; CRM</div>
            <h3>Chaque lead atterrit au bon endroit.</h3>
          </div>
        </div>
      ...
      <div class="sv-integ-group reveal reveal-d-1">
        <div class="sv-integ-head">
          ...
          <div>
            <div class="sv-integ-kind">PRISE DE RENDEZ-VOUS</div>
            <h3>Du formulaire au créneau réservé.</h3>
          </div>
        </div>
        <div class="sv-integ-chips">
          <span>Calendly</span>
      ...
      <div class="sv-integ-group reveal reveal-d-2">
        <div class="sv-integ-head">
          ...
          <div>
            <div class="sv-integ-kind">CMS &amp; CONTENU</div>
            <h3>Votre équipe publie sans nous appeler.</h3>
          </div>
        </div>
        <div class="sv-integ-chips">
          <span>Sanity</span>
      ...
      <div class="sv-integ-group reveal">
        <div class="sv-integ-head">
          ...
          <div>
            <div class="sv-integ-kind">ANALYTICS &amp; TRACKING</div>
            <h3>Mesurer ce qui convertit, proprement.</h3>
          </div>
        </div>
        <div class="sv-integ-chips">
          <span>GA4</span>
      ...
      <div class="sv-integ-group reveal reveal-d-2">
        <div class="sv-integ-head">
          ...
          <div>
            <div class="sv-integ-kind">COMMUNICATION &amp; MARKETING</div>
