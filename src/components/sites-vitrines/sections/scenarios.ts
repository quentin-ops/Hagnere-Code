...
<section class="sv-scenarios" data-active="refonte">
  ...
  <div class="wrap">
    <div class="section-head reveal">
      ...
      <div class="right">
        Ces trois scénarios illustrent des périmètres possibles sans prétendre décrire des projets déjà livrés.
        <b>Cliquez sur le plus proche</b>&nbsp;: l'équipe, le calendrier, les livrables et le prix restent confirmés au devis.
      </div>
    </div>

    <div class="sv-scen-tabs reveal" role="tablist" aria-label="Choisir un scénario">
      <button type="button" class="sv-scen-tab is-active" data-scenario="refonte" role="tab" aria-selected="true" id="sv-scenario-tab-refonte" aria-controls="sv-scenario-panel-refonte" tabindex="0">
        ...
        <div class="sv-scen-tab-body">
          <div class="sv-scen-tab-top">
            ...
            <span class="sv-scen-tab-d">Planning sur devis</span>
          </div>
      ...
      <button type="button" class="sv-scen-tab" data-scenario="landing" role="tab" aria-selected="false" id="sv-scenario-tab-landing" aria-controls="sv-scenario-panel-landing" tabindex="-1">
        <div class="sv-scen-tab-ic">
        ...
        <div class="sv-scen-tab-body">
          ...
          <div class="sv-scen-tab-sub">« Ma campagne Ads a une date de lancement »</div>
        </div>
        <div class="sv-scen-tab-chev">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
        </div>
      ...
      <button type="button" class="sv-scen-tab" data-scenario="seo" role="tab" aria-selected="false" id="sv-scenario-tab-seo" aria-controls="sv-scenario-panel-seo" tabindex="-1">
        <div class="sv-scen-tab-ic">
    ...
    <!-- PANEL refonte -->
    <div class="sv-scen-panel is-active" data-panel="refonte" role="tabpanel" tabindex="0" aria-hidden="false" id="sv-scenario-panel-refonte" aria-labelledby="sv-scenario-tab-refonte">
      <div class="sv-scen-cols">
        ...
        <div class="sv-scen-aside">
          ...
          <dl class="sv-scen-meta">
            ...
            <div class="sv-scen-meta-row">
              <dt>Livrables</dt>
              <dd>Mise en ligne, documentation et formation selon le devis</dd>
            </div>
            <div class="sv-scen-meta-row">
              <dt>Paiement</dt>
            ...
            <div class="sv-scen-meta-row">
              <dt>Garantie</dt>
              <dd>Période définie au devis</dd>
            </div>
          </dl>
    ...
    <!-- PANEL landing -->
    <div class="sv-scen-panel" data-panel="landing" role="tabpanel" tabindex="0" aria-hidden="true" id="sv-scenario-panel-landing" aria-labelledby="sv-scenario-tab-landing" hidden>
      <div class="sv-scen-cols">
        <div class="sv-scen-main">
          <div class="sv-scen-kind">Landing Page · Lancement produit</div>
          <h3>« Je lance un produit, ma campagne Ads a une date de démarrage. »</h3>
          <p class="sv-scen-lead">
    ...
    <!-- PANEL seo -->
    <div class="sv-scen-panel" data-panel="seo" role="tabpanel" tabindex="0" aria-hidden="true" id="sv-scenario-panel-seo" aria-labelledby="sv-scenario-tab-seo" hidden>
      <div class="sv-scen-cols">
        <div class="sv-scen-main">
