...
<!-- TRUST BADGES ADS — engagements contractuels -->
<section class="ads-trust">
  <div class="wrap">
    <div class="ads-trust-head reveal">
    ...
    <div class="ads-trust-grid">
      <div class="ads-trust-card reveal">
        ...
        <h3>Forfait fixe · aucun % du media</h3>
      ...
      <div class="ads-trust-card reveal reveal-d-1">
        ...
        <h3>Comptes sous contrôle client</h3>
      ...
      <div class="ads-trust-card reveal reveal-d-3">
        ...
        <h3>Healthchecks tracking configurables</h3>
      ...
      <div class="ads-trust-card reveal">
        ...
        <h3>Rythme de pilotage documenté</h3>
      ...
      <div class="ads-trust-card reveal reveal-d-1">
        ...
        <h3>Reporting business (pas vanity)</h3>
      ...
      <div class="ads-trust-card reveal reveal-d-3">
        ...
        <h3>Durée et sortie lisibles</h3>
