...
<!-- PROCESS — 7 étapes Ads, 3 phases -->
<section class="ads-proc" id="process">
  <div class="wrap">
    <div class="section-head reveal">
      <div class="left">
        <div class="eyebrow">— Notre process</div>
        <h2>Du kickoff aux premières<br>conversions attribuées CRM,<br>en 7 étapes.</h2>
      </div>
      <div class="right">
        Pas de « livrable fantôme » qui arrive après 3 mois. Trois phases, sept étapes,
        jalons documentés. <b>Vous savez à tout moment où on en est</b> et ce qui arrive
        la semaine suivante.
      </div>
    </div>

    <!-- PHASE 1 : SETUP -->
    <div class="ads-proc-phase reveal">
      <div class="ads-proc-phase-head" data-phase="setup">
        <span class="ads-proc-phase-k">PHASE 01 · SETUP</span>
        <span class="ads-proc-phase-d">Semaine 1 → 4</span>
        <span class="ads-proc-phase-n">4 étapes</span>
      </div>
    </div>
    <div class="ads-proc-grid reveal reveal-d-1">
      <article class="ads-proc-step" data-phase="setup">
        <div class="ads-proc-step-top">
          <span class="ads-proc-step-n">01</span>
          <div class="ads-proc-step-ic">
      ...
      <article class="ads-proc-step" data-phase="setup">
        <div class="ads-proc-step-top">
          <span class="ads-proc-step-n">02</span>
          <div class="ads-proc-step-ic">
      ...
      <article class="ads-proc-step" data-phase="setup">
        <div class="ads-proc-step-top">
          <span class="ads-proc-step-n">03</span>
          <div class="ads-proc-step-ic">
      ...
      <article class="ads-proc-step" data-phase="setup">
        <div class="ads-proc-step-top">
          <span class="ads-proc-step-n">04</span>
          <div class="ads-proc-step-ic">
    ...
    <!-- PHASE 2 : LAUNCH -->
    <div class="ads-proc-phase reveal">
      <div class="ads-proc-phase-head" data-phase="launch">
        <span class="ads-proc-phase-k">PHASE 02 · LAUNCH</span>
        <span class="ads-proc-phase-d">Semaine 5 → 12</span>
        <span class="ads-proc-phase-n">2 étapes</span>
      </div>
    </div>
    <div class="ads-proc-grid ads-proc-grid-2 reveal reveal-d-1">
      <article class="ads-proc-step" data-phase="launch">
        <div class="ads-proc-step-top">
          <span class="ads-proc-step-n">05</span>
          <div class="ads-proc-step-ic">
      ...
      <article class="ads-proc-step" data-phase="launch">
        <div class="ads-proc-step-top">
          <span class="ads-proc-step-n">06</span>
          <div class="ads-proc-step-ic">
    ...
    <!-- PHASE 3 : PILOTAGE -->
    <div class="ads-proc-phase reveal">
      <div class="ads-proc-phase-head" data-phase="pilot">
        <span class="ads-proc-phase-k">PHASE 03 · PILOTAGE</span>
        <span class="ads-proc-phase-d">Mois 3+ · rituel permanent</span>
        <span class="ads-proc-phase-n">1 étape en continu</span>
      </div>
    </div>
    <div class="ads-proc-grid ads-proc-grid-1 reveal reveal-d-1">
      <article class="ads-proc-step ads-proc-step-wide" data-phase="pilot">
        <div class="ads-proc-step-top">
          <span class="ads-proc-step-n">07</span>
          <div class="ads-proc-step-ic">
        ...
        <div class="ads-proc-step-wide-body">
          ...
          <div class="ads-proc-step-wide-grid">
            <div class="ads-proc-step-wide-item">
              <span class="ads-proc-step-wide-k">Lundi 30 min</span>
              <span class="ads-proc-step-wide-v">Point hebdo · décisions documentées Notion</span>
            </div>
            <div class="ads-proc-step-wide-item">
              <span class="ads-proc-step-wide-k">Jeudi 1 h</span>
              <span class="ads-proc-step-wide-v">Revue creative · brief du batch suivant</span>
            </div>
            <div class="ads-proc-step-wide-item">
              <span class="ads-proc-step-wide-k">Le 5 du mois</span>
              <span class="ads-proc-step-wide-v">Reporting business · CAC / ROAS / margin</span>
            </div>
            <div class="ads-proc-step-wide-item">
              <span class="ads-proc-step-wide-k">Temps réel</span>
              <span class="ads-proc-step-wide-v">Alertes Slack · spend / CPA / tracking</span>
            </div>
          </div>
        </div>
      </article>
