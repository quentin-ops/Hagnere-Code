...
<!-- VERTICALS — 6 secteurs Ads -->
<section class="ads-verticals">
  <div class="wrap">
    ...
    <div class="ads-vt-grid">
      ...
      <div class="ads-vt-card reveal reveal-d-2">
        ...
        <div class="ads-vt-feats">
          <span>Meta Lead Gen</span>
          <span>YouTube TrueView</span>
      ...
      <div class="ads-vt-card reveal">
        <div class="ads-vt-head">
          <div class="ads-vt-ic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 1118 0z"/><circle cx="12" cy="10" r="3"/></svg></div>
          <span class="ads-vt-tag">● Courant</span>
        </div>
        <h3>Services locaux multi-sites</h3>
        <p>Artisans, franchises, cabinets, multi-villes. <b>Google Search local + Meta geo-targeted + GBP Ads</b>. Exclusions villes non desservies, Local Service Ads si éligible, suivi appels-leads.</p>
        <div class="ads-vt-feats">
      ...
      <!-- 05 Marketplace / Platform -->
      <div class="ads-vt-card reveal reveal-d-1">
        <div class="ads-vt-head">
          <div class="ads-vt-ic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="12" cy="18" r="3"/><path d="M9 6h6M8 8l3 7M16 8l-3 7"/></svg></div>
          <span class="ads-vt-tag">● Courant</span>
        </div>
        ...
        <div class="ads-vt-feats">
          ...
          <span>Dual-side tracking</span>
        </div>
      </div>

      <!-- 06 Lancement produit / levée -->
      <div class="ads-vt-card reveal reveal-d-2">
        <div class="ads-vt-head">
          <div class="ads-vt-ic"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9z"/></svg></div>
