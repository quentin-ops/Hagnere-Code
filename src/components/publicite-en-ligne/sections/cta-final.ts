...
<section class="scta">
  ...
  <div class="wrap">
    ...
    <h2 style="margin-top:18px">30 minutes pour savoir<br>si votre setup Ads fuit — ou pas.</h2>
    <p>Un consultant senior regarde avec vous votre compte Google Ads, Meta ou LinkedIn, votre tracking et votre funnel CRM. Vous repartez avec <b>3 points concrets à corriger</b> sous 7 jours, qu'on bosse ensemble ou pas.</p>
    <div class="scta-cta">
      <a href="#contact" class="btn btn-accent btn-lg">
        Réserver l'audit Ads offert
    ...
    <div class="scta-meta">AUDIT 30 MIN OFFERT · PAR UN CONSULTANT SENIOR · RAPPORT ÉCRIT SOUS 48 H</div>
  </div>
</section>
`;
