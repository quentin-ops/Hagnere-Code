...
<section class="ads-arch">
  <div class="wrap">
    <div class="section-head reveal">
      ...
      <div class="right">
        Schéma de référence à adapter au projet : front-ends web &amp; mobile, API Next.js,
        données, services externes et infrastructure. Il ne décrit pas une architecture
        client vérifiable ; le devis liste les briques, dépendances et responsabilités retenues.
      </div>
    </div>

    <div class="ads-arch-diagram reveal">
    ...
    <div class="ads-arch-caption reveal">
      <div class="ads-arch-caption-k">
        <span><span class="ads-arch-dot" style="background:#6D28D9"></span> Cœur de la stack</span>
        <span><span class="ads-arch-dot" style="background:#404040"></span> Composants maîtrisés</span>
        <span><span class="ads-arch-dot" style="background:rgba(255,255,255,0.2)"></span> Services externes</span>
      </div>
      <p>
