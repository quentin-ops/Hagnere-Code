 ...
 *   CAPABILITIES → ROI DASHBOARD → ECOSYSTEM → PROCESS →
 *   SCENARIOS 4 tabs → DE-RISK (+ engagements écrits) → COMPARISON → TESTIMONIALS → REFUSE →
 *   PRICING (porte d'entrée + 3 rythmes de pilotage) →
 *   FAQ unique (12 Q commerciales + 8 Q techniques) →
