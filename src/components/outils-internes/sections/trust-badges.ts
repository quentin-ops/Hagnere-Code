...
<!-- TRUST BADGES OUTILS INTERNES -->
<section class="oi-trust">
  <div class="wrap">
    <div class="oi-trust-head reveal">
      <div class="eyebrow">— Engagements &amp; garanties</div>
      <h2>Ce qu'on signe<br>avant de commencer.</h2>
      <p>Cette page décrit les points à cadrer. Seuls les engagements repris dans le devis ou le contrat signé s'appliquent au projet.</p>
    </div>

    <div class="oi-trust-grid">
      <div class="oi-trust-card reveal">
        ...
        <div class="oi-trust-foot">— Périmètre et changements écrits</div>
      </div>
      ...
      <div class="oi-trust-card reveal reveal-d-1">
        ...
        <p>Le devis précise le fournisseur, le compte, la région, les sous-traitants, le chiffrement, les sauvegardes, la rétention et les tests de restauration.</p>
        <div class="oi-trust-foot">— Architecture propre au projet</div>
      </div>
      ...
      <div class="oi-trust-card reveal reveal-d-2">
        ...
        <p>Les livrables spécifiques sont transférés après paiement complet selon les CGV. Le devis précise le dépôt, les accès, la réversibilité et les licences applicables.</p>
        <div class="oi-trust-foot">— Cession et exclusions explicites</div>
      </div>

      <div class="oi-trust-card reveal reveal-d-3">
        <div class="oi-trust-ic">
        ...
        <p>Si le projet comporte de véritables opérations de R&amp;D individualisées, nous documentons les verrous, essais et résultats. <b>L'éligibilité au CIR reste à valider</b> selon les travaux, votre situation et l'agrément du prestataire.</p>
        <div class="oi-trust-foot">— Documentation technique livrée à la réception</div>
      </div>
      ...
      <div class="oi-trust-card reveal">
        ...
        <h4>Formation écrite au devis</h4>
        <p>Publics, durée, supports, sessions de suivi et critères d'autonomie sont adaptés au projet et inventoriés avant signature.</p>
        <div class="oi-trust-foot">— Modalités propres au projet</div>
      </div>
      ...
      <div class="oi-trust-card reveal reveal-d-1">
        ...
        <h4>Passation inventoriée</h4>
        <p>Le devis précise les documents de sortie&nbsp;: architecture, dépendances, risques connus, runbook, accès et modalités de transfert à une autre équipe.</p>
        <div class="oi-trust-foot">— Livrables de sortie au devis</div>
      </div>
      ...
      <div class="oi-trust-card reveal reveal-d-2">
        ...
        <h4>Adoption mesurée</h4>
        <p>Référents, tests, formation, documentation, indicateurs et éventuelles sessions après lancement sont cadrés. Aucun taux d'adoption n'est garanti.</p>
        <div class="oi-trust-foot">— Dispositif défini au contrat</div>
      </div>
      ...
      <div class="oi-trust-card reveal reveal-d-3">
        ...
        <h4>Stack et dépendances documentées</h4>
        <p>Les technologies, versions, composants préexistants, services tiers et licences sont inventoriés. La durée de reprise dépend du périmètre et de la qualité de la passation.</p>
        <div class="oi-trust-foot">— Réversibilité vérifiable</div>
      </div>
