...
<!-- CE QU'ON REFUSE -->
<section class="oi-refuse">
  <div class="wrap">
    <div class="oi-refuse-grid">
      <div class="oi-refuse-intro reveal">
        <div class="eyebrow">— Les projets qu'on décline</div>
        <h2>Certains deals ne sont<br>pas pour nous.</h2>
        <p>
          On ne filtre pas sur le secteur — on filtre sur la <b>faisabilité, la légalité, et la santé
          du projet</b>. Si votre dossier coche l'une des cases ci-contre, on déclinera franchement,
          quelle que soit la taille du chèque.
        </p>
      ...
      <ul class="oi-refuse-list reveal reveal-d-1">
        <li>
