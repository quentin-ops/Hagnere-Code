  ...
  <div class="wrap">
    ...
    <div class="at-proc-phase reveal">
      <div class="at-proc-phase-head" data-phase="setup">
        <span class="at-proc-phase-k">PHASE 01 · ONBOARDING</span>
        <span class="at-proc-phase-d">Jour -5 → Semaine 4</span>
        <span class="at-proc-phase-n">4 étapes</span>
      </div>
    </div>
    <div class="at-proc-grid reveal reveal-d-1">
      <article class="at-proc-step" data-phase="setup">
        ...
        <div class="at-proc-step-foot">J-5 → J+5 · 2 devs full-time</div>
      </article>
      ...
      <article class="at-proc-step" data-phase="setup">
        ...
        <div class="at-proc-step-foot">Semaine 1 → 2 · sans coupure</div>
      </article>
      ...
      <article class="at-proc-step" data-phase="setup">
        ...
        <div class="at-proc-step-foot">Semaine 2 → 3 · alerte Slack live</div>
      </article>
      ...
      <article class="at-proc-step" data-phase="setup">
        ...
        <div class="at-proc-step-foot">Semaine 3 → 4 · comité J+30 calé</div>
      </article>
    </div>
    ...
    <div class="at-proc-phase reveal">
      <div class="at-proc-phase-head" data-phase="launch">
        <span class="at-proc-phase-k">PHASE 02 · RUN</span>
        <span class="at-proc-phase-d">Mois 2 → permanent</span>
    ...
    <div class="at-proc-grid at-proc-grid-2 reveal reveal-d-1">
      <article class="at-proc-step" data-phase="launch">
        ...
        <div class="at-proc-step-foot">Rythme hebdo · 52 sprints/an</div>
      </article>
      ...
      <article class="at-proc-step" data-phase="launch">
        ...
        <div class="at-proc-step-foot">Le 5 du mois · 1 h · rapport 15-20 p.</div>
      </article>
    </div>
    ...
    <div class="at-proc-phase reveal">
      <div class="at-proc-phase-head" data-phase="pilot">
        <span class="at-proc-phase-k">PHASE 03 · SCALE &amp; RÉVISION</span>
        <span class="at-proc-phase-d">Trimestriel + annuel</span>
        <span class="at-proc-phase-n">1 étape en continu</span>
      </div>
    </div>
    <div class="at-proc-grid at-proc-grid-1 reveal reveal-d-1">
      <article class="at-proc-step at-proc-step-wide" data-phase="pilot">
        <div class="at-proc-step-top">
        ...
        <div class="at-proc-step-wide-body">
          ...
          <div class="at-proc-step-wide-grid">
            <div class="at-proc-step-wide-item">
              <span class="at-proc-step-wide-k">Chaque lundi</span>
              <span class="at-proc-step-wide-v">Standup Slack · priorités de la semaine</span>
            </div>
            <div class="at-proc-step-wide-item">
              <span class="at-proc-step-wide-k">Le 5 du mois</span>
              <span class="at-proc-step-wide-v">Comité 1 h · rapport mensuel</span>
            </div>
            <div class="at-proc-step-wide-item">
              <span class="at-proc-step-wide-k">Fin trimestre</span>
              <span class="at-proc-step-wide-v">Revue DORA · ajustement forfait</span>
            </div>
            <div class="at-proc-step-wide-item">
              <span class="at-proc-step-wide-k">Annuel</span>
              <span class="at-proc-step-wide-v">Revue stratégique · renégociation</span>
            </div>
          </div>
        </div>
      </article>
