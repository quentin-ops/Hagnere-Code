    ...
    <div class="at-refuse-grid">
      ...
      <ul class="at-refuse-list reveal reveal-d-1">
        <li>
          ...
          <div>
            <h4>Audits politiques · pour valider une position interne</h4>
        ...
        <li>
          <div class="at-refuse-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div>
          <div>
            <h4>Audits "boîte noire" · sans accès code ni entretiens</h4>
        ...
        <li>
          <div class="at-refuse-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div>
          <div>
            <h4>Audits suivis d'une refonte qu'on aurait chiffrée pendant l'audit</h4>
        ...
        <li>
          <div class="at-refuse-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div>
          <div>
            <h4>Audits anonymes contre un client existant ou ex-client</h4>
        ...
        <li>
          ...
          <div>
            ...
            <p>Le NDA mutuel est signé avant le premier call technique, <b>pas après</b>. Si un prospect refuse de signer avant de voir "ce qu'on va trouver", c'est un red flag qui a toujours mal fini dans nos 47 audits. On protège nos méthodes autant que vos données.</p>
          </div>
        </li>
      </ul>
    </div>
