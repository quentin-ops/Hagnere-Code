...
<section class="caps" id="capabilities">
  ...
  <div class="wrap">
    ...
    <details class="at-caps-fam reveal" open>
      <summary class="at-caps-family-head">
      ...
      <div class="caps-grid">
        ...
        <div class="cap reveal reveal-d-1">
          ...
          <h3>Coverage &amp; complexité par module</h3>
    ...
    <details class="at-caps-fam reveal">
      <summary class="at-caps-family-head">
      ...
      <div class="caps-grid">
        <div class="cap reveal">
          ...
          <h3>Diagrammes C4 AS-IS + TO-BE</h3>
        ...
        <div class="cap reveal reveal-d-2">
          ...
          <h3>Data flow &amp; bounded contexts</h3>
    ...
    <details class="at-caps-fam reveal">
      ...
      <div class="caps-grid">
        <div class="cap reveal">
          ...
          <h3>Latence p95 / p99 par endpoint</h3>
        ...
        <div class="cap reveal reveal-d-1">
          ...
          <h3>N+1, indexes manquants, full scans</h3>
        ...
        <div class="cap reveal reveal-d-2">
          ...
          <h3>Core Web Vitals &amp; bundle size</h3>
    ...
    <details class="at-caps-fam reveal">
      ...
      <div class="caps-grid">
        <div class="cap reveal">
          ...
          <h3>OWASP Top 10 2021 + auth/authz</h3>
        ...
        <div class="cap reveal reveal-d-1">
          ...
          <h3>CVE dépendances + secrets leaks</h3>
    ...
    <details class="at-caps-fam reveal">
      ...
      <div class="caps-grid">
        ...
        <div class="cap reveal reveal-d-1">
          ...
          <h3>Monitoring &amp; SPOF detection</h3>
    ...
    <details class="at-caps-fam reveal">
      ...
      <div class="caps-grid">
        <div class="cap reveal">
          ...
          <h3>4 métriques DORA chiffrées</h3>
        ...
        <div class="cap reveal reveal-d-1">
          ...
          <h3>Bus factor + onboarding flow</h3>
    ...
    <details class="at-caps-fam reveal">
      ...
      <div class="caps-grid">
        <div class="cap reveal">
          ...
          <h3>Cost per feature / per customer</h3>
        ...
        <div class="cap reveal reveal-d-1">
          ...
          <h3>Over-provisioning + ressources zombie</h3>
    ...
    <details class="at-caps-fam reveal">
      ...
      <div class="caps-grid">
        <div class="cap reveal">
          ...
          <h3>5 à 8 entretiens no-blame</h3>
        ...
        <div class="cap reveal reveal-d-1">
          <div class="cap-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 15l4-6 4 3 5-8"/></svg></div>
          <h3>Turnover &amp; séniorité de vos équipes</h3>
        ...
        <div class="cap reveal reveal-d-2">
          <div class="cap-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9z"/></svg></div>
          <h3>Vélocité mesurée vs. déclarée</h3>
