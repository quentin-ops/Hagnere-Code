  ...
  <div class="wrap">
    ...
    <div class="at-trust-grid">
      <div class="at-trust-card reveal">
        ...
        <h4>Confidentialité avant les accès</h4>
      ...
      <div class="at-trust-card reveal reveal-d-1">
        ...
        <h4>Diagnostic et remédiation séparés</h4>
      ...
      <div class="at-trust-card reveal reveal-d-2">
        ...
        <h4>Critères d'acceptation définis</h4>
      ...
      <div class="at-trust-card reveal reveal-d-1">
        ...
        <h4>Références sous contrôle du client</h4>
      ...
      <div class="at-trust-card reveal reveal-d-2">
        ...
        <h4>Exemple interne sur demande</h4>
      ...
      <div class="at-trust-card reveal reveal-d-3">
        ...
        <h4>Droits et réversibilité clarifiés</h4>
