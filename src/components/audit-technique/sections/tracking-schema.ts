...
<section class="me-track" id="tracking">
  <div class="at-track-bg-grid" aria-hidden="true"></div>
  <div class="wrap">
    ...
    <div class="at-track-stats reveal">
      <div class="at-track-stat">
        <div class="at-track-stat-v">+42<span>%</span></div>
        <div class="at-track-stat-k">Signaux de conversion récupérés</div>
        <div class="at-track-stat-n">vs. setup client-side classique</div>
      </div>
      <div class="at-track-stat at-track-stat-hot">
        <div class="at-track-stat-v">×2,3</div>
        <div class="at-track-stat-k">ROAS affiché plus proche du réel</div>
        <div class="at-track-stat-n">matching CRM vs. plateformes</div>
      </div>
      <div class="at-track-stat">
        <div class="at-track-stat-v">100<span>%</span></div>
        <div class="at-track-stat-k">Conforme RGPD &amp; Consent Mode v2</div>
        <div class="at-track-stat-n">modeled conversions incluses</div>
      </div>
      <div class="at-track-stat">
        <div class="at-track-stat-v">3<span>sem.</span></div>
        <div class="at-track-stat-k">Pour déployer toute la stack</div>
        <div class="at-track-stat-n">GTM SS + CAPI + EC + CRM webhook</div>
      </div>
    </div>

    <!-- PIPELINE : 4 stations -->
    <div class="at-track-pipe reveal reveal-d-1">

      <!-- 01 -->
      <div class="at-track-node at-track-node-in">
        <div class="at-track-node-head">
          <span class="at-track-node-n">01</span>
          <div class="at-track-node-ic">
        ...
        <div class="at-track-node-tags">
          <span>user.id</span>
          <span>event.id</span>
        </div>
      </div>

      <div class="at-track-arrow" aria-hidden="true">
      ...
      <!-- 02 -->
      <div class="at-track-node">
        <div class="at-track-node-head">
          <span class="at-track-node-n">02</span>
          <div class="at-track-node-ic">
      ...
      <!-- 03 (core) -->
      <div class="at-track-node at-track-node-core">
        <div class="at-track-node-head">
          <span class="at-track-node-n">03</span>
          <div class="at-track-node-ic">
        ...
        <div class="at-track-node-badge">Notre stack</div>
      </div>
      ...
      <!-- 04 -->
      <div class="at-track-node at-track-node-out">
        <div class="at-track-node-head">
          <span class="at-track-node-n">04</span>
          <div class="at-track-node-ic">
    ...
    <div class="at-track-zones reveal reveal-d-2">
      <div class="at-track-zone-card">
        <div class="at-track-zone-head">
          <span class="at-track-zone-n">01</span>
          <span class="at-track-zone-k">First-party data</span>
        </div>
      ...
      <div class="at-track-zone-card">
        <div class="at-track-zone-head">
          <span class="at-track-zone-n">02</span>
          <span class="at-track-zone-k">Dedupe &amp; filtering</span>
        </div>
      ...
      <div class="at-track-zone-card">
        <div class="at-track-zone-head">
          <span class="at-track-zone-n">03</span>
          <span class="at-track-zone-k">Conversion APIs</span>
        </div>
      ...
      <div class="at-track-zone-card">
        <div class="at-track-zone-head">
          <span class="at-track-zone-n">04</span>
          <span class="at-track-zone-k">CRM attribution</span>
        </div>
      ...
      <div class="at-track-zone-card">
        <div class="at-track-zone-head">
          <span class="at-track-zone-n">05</span>
          <span class="at-track-zone-k">Consent Mode v2</span>
        </div>
      ...
      <div class="at-track-zone-card">
        <div class="at-track-zone-head">
          <span class="at-track-zone-n">06</span>
          <span class="at-track-zone-k">Looker Studio</span>
        </div>
