      ...
      <div class="at-check-col at-check-out reveal reveal-d-1">
        ...
        <ul class="at-check-list at-check-list-out">
          <li>
            ...
            <div><b>Pentest externe indépendant</b> — prestataire et budget à sélectionner&nbsp;; qualification PASSI vérifiée <a href="https://cyber.gouv.fr/produits-services-qualifies" rel="noopener nofollow" target="_blank">à l'annuaire de l'ANSSI</a> si elle est exigée par le cahier des charges.</div>
          </li>
          <li>
            <div class="at-check-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 6l12 12M6 18L18 6"/></svg></div>
