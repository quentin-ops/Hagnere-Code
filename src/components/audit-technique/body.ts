  ...
  <div class="wrap">
    ...
    <div class="caps-grid">
      ...
      <div class="cap reveal reveal-d-3">
        ...
        <p>Nous vérifions uniquement les types pertinents pour le contenu visible et encore pris en charge par Google, puis leur syntaxe et leurs propriétés requises. Un balisage valide ne garantit aucun résultat enrichi.</p>
      </div>
      <div class="cap reveal">
