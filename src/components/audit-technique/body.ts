...
<section class="shero">
  ...
  <div class="wrap shero-inner">
    ...
    <!-- VISUAL : les deux maquettes vivent dans la colonne de droite, à hauteur
         du titre, et la réserve « exemple illustratif » les légende par-dessous.
         Avant le 31/08/2026 cette réserve était un troisième enfant direct de
         .shero-inner : la grille à deux colonnes la plaçait seule en (ligne 1,
         colonne 2) et renvoyait les maquettes en (ligne 2, colonne 1). La moitié
         droite du premier écran était vide, la légende ne légendait rien, et la
         section montait à 1 728 px. Un seul enfant par colonne, comme sur
      ...
      <div class="shero-visual">
        <div class="mock-window mw-main">
          ...
          <svg width="100%" viewBox="0 0 540 360" style="display:block">
            ...
            <!-- Les deux pastilles étaient plus étroites que leur texte : en Geist Mono
                 9 px (~5,4 px par glyphe), « ● CONFIDENTIEL » demande 76 px pour un cadre
                 de 72, et « EXEMPLE · FICTIF » 87 px pour un cadre de 66. Les deux
                 libellés débordaient et se touchaient : on lisait
                 « CONFIDENTIELEXEMPLE · FICTIF » en plein premier écran. -->
            <rect x="312" y="12" width="94" height="20" rx="4" fill="#FEF2F2" stroke="#FCA5A5"/>
            <text x="359" y="26" text-anchor="middle" font-family="Geist Mono" font-size="9" font-weight="700" fill="#B91C1C">● CONFIDENTIEL</text>
            <rect x="416" y="12" width="104" height="20" rx="4" fill="#F5F5F5"/>
            <text x="468" y="26" text-anchor="middle" font-family="Geist Mono" font-size="9" font-weight="600" fill="#737373">EXEMPLE · FICTIF</text>
