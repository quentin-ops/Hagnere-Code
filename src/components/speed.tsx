...
export const Speed = () => {
  return (
    <section className="relative overflow-visible">
      {/* Green halo blob */}
      <div
        className="pointer-events-none absolute top-0 -right-[300px] w-[800px] h-[800px] opacity-30"
        style={{
      ...
      <Container className="relative z-10 py-10 md:py-20 lg:py-32">
        <div className="flex flex-col gap-6 items-end">
          <Heading className="text-center lg:text-right bg-gradient-to-l from-neutral-900 via-green-500 to-green-500 dark:from-white dark:via-green-400 dark:to-green-500 bg-clip-text text-transparent pb-2 max-w-5xl text-2xl md:text-3xl lg:text-4xl">
            Nous concevons des solutions concrètes pour automatiser, connecter et simplifier votre quotidien.
          </Heading>
          <Subheading className="text-center lg:text-right max-w-3xl">
            Automatisation intelligente, intégrations sur-mesure, agents IA.
            Nous développons des solutions qui remplacent les tâches manuelles,
            connectent vos outils existants et sécurisent vos processus.
          </Subheading>
        </div>
      </Container>
      <div className="mx-auto mb-20 w-full max-w-7xl px-4 md:px-8">
        <div className="cols-1 grid gap-4 md:auto-rows-[25rem] md:grid-cols-5">
          <Card className="flex flex-col justify-between md:col-span-3">
            <CardSkeletonBody>
              <SkeletonOne />
            </CardSkeletonBody>
            <CardContent className="h-40">
              <CardTitle>Livraison rapide, sans risque</CardTitle>
              <CardDescription>
                Nous automatisons le déploiement et les mises à jour de vos applications pour livrer vite, sans interruption de service, avec un contrôle total sur la qualité et la sécurité.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="flex flex-col justify-between md:col-span-2">
            <CardContent className="h-44">
              <CardTitle>Des outils que vos équipes adoptent</CardTitle>
              <CardDescription>
                Nous concevons des interfaces simples et efficaces, pensées pour vos usages métiers, afin que vos équipes utilisent réellement l&apos;outil au quotidien, sans résistance ni formation lourde.
              </CardDescription>
            </CardContent>
            <CardSkeletonBody>
          ...
          <Card className="flex flex-col justify-between md:col-span-2">
            <CardContent className="h-40">
              <CardTitle>Une infrastructure prête à grandir</CardTitle>
              <CardDescription>
                Nous déployons des architectures solides et évolutives, capables de supporter la montée en charge, la croissance de vos données et l&apos;évolution de vos besoins, sans tout reconstruire.
              </CardDescription>
            </CardContent>
            <CardSkeletonBody>
              <SkeletonTwo />
          ...
          <Card className="flex flex-col justify-between md:col-span-3">
            <CardContent className="h-40">
              <CardTitle>Des données enfin utiles</CardTitle>
              <CardDescription>
                Nous structurons, connectons et exploitons vos données pour les rendre actionnables : automatisation des processus, analyses fiables et intégration fluide avec l&apos;IA.
              </CardDescription>
            </CardContent>
            <CardSkeletonBody>
              <div className="mt-2 ml-6 h-full w-full rounded-lg border border-neutral-200 bg-neutral-100 p-4 dark:border-neutral-700 dark:bg-neutral-800">
