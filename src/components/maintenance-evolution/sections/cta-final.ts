...
<section class="scta">
  ...
  <div class="wrap">
    ...
    <h2 style="margin-top:18px">Un premier échange pour<br>qualifier l'état de votre app<br>et le diagnostic nécessaire.</h2>
    ...
    <div class="scta-meta">ÉCHANGE SANS ENGAGEMENT · DIAGNOSTIC ET RAPPORT SUR DEVIS</div>
  </div>
</section>
`;
