...
<section class="me-track" id="tracking">
  <div class="me-track-bg-grid" aria-hidden="true"></div>
  <div class="wrap">
    ...
    <div class="me-track-stats reveal">
      <div class="me-track-stat">
        <div class="me-track-stat-v">+42<span>%</span></div>
        <div class="me-track-stat-k">Signaux de conversion récupérés</div>
        <div class="me-track-stat-n">vs. setup client-side classique</div>
      </div>
      <div class="me-track-stat me-track-stat-hot">
        <div class="me-track-stat-v">×2,3</div>
        <div class="me-track-stat-k">ROAS affiché plus proche du réel</div>
        <div class="me-track-stat-n">matching CRM vs. plateformes</div>
      </div>
      <div class="me-track-stat">
        <div class="me-track-stat-v">100<span>%</span></div>
        <div class="me-track-stat-k">Conforme RGPD &amp; Consent Mode v2</div>
        <div class="me-track-stat-n">modeled conversions incluses</div>
      </div>
      <div class="me-track-stat">
        <div class="me-track-stat-v">3<span>sem.</span></div>
        <div class="me-track-stat-k">Pour déployer toute la stack</div>
        <div class="me-track-stat-n">GTM SS + CAPI + EC + CRM webhook</div>
      </div>
    </div>

    <!-- PIPELINE : 4 stations -->
    <div class="me-track-pipe reveal reveal-d-1">

      <!-- 01 -->
      <div class="me-track-node me-track-node-in">
        <div class="me-track-node-head">
          <span class="me-track-node-n">01</span>
          <div class="me-track-node-ic">
        ...
        <div class="me-track-node-tags">
          <span>user.id</span>
          <span>event.id</span>
        </div>
      </div>

      <div class="me-track-arrow" aria-hidden="true">
      ...
      <!-- 02 -->
      <div class="me-track-node">
        <div class="me-track-node-head">
          <span class="me-track-node-n">02</span>
          <div class="me-track-node-ic">
      ...
      <!-- 03 (core) -->
      <div class="me-track-node me-track-node-core">
        <div class="me-track-node-head">
          <span class="me-track-node-n">03</span>
          <div class="me-track-node-ic">
        ...
        <div class="me-track-node-badge">Notre stack</div>
      </div>
      ...
      <!-- 04 -->
      <div class="me-track-node me-track-node-out">
        <div class="me-track-node-head">
          <span class="me-track-node-n">04</span>
          <div class="me-track-node-ic">
    ...
    <div class="me-track-zones reveal reveal-d-2">
      <div class="me-track-zone-card">
        <div class="me-track-zone-head">
          <span class="me-track-zone-n">01</span>
          <span class="me-track-zone-k">First-party data</span>
        </div>
      ...
      <div class="me-track-zone-card">
        <div class="me-track-zone-head">
          <span class="me-track-zone-n">02</span>
          <span class="me-track-zone-k">Dedupe &amp; filtering</span>
        </div>
      ...
      <div class="me-track-zone-card">
        <div class="me-track-zone-head">
          <span class="me-track-zone-n">03</span>
          <span class="me-track-zone-k">Conversion APIs</span>
        </div>
      ...
      <div class="me-track-zone-card">
        <div class="me-track-zone-head">
          <span class="me-track-zone-n">04</span>
          <span class="me-track-zone-k">CRM attribution</span>
        </div>
      ...
      <div class="me-track-zone-card">
        <div class="me-track-zone-head">
          <span class="me-track-zone-n">05</span>
          <span class="me-track-zone-k">Consent Mode v2</span>
        </div>
      ...
      <div class="me-track-zone-card">
        <div class="me-track-zone-head">
          <span class="me-track-zone-n">06</span>
          <span class="me-track-zone-k">Looker Studio</span>
        </div>
