...
<section class="me-eco" id="ecosysteme">
  <div class="wrap">
    ...
    <article class="me-eco-station reveal">
      <div class="me-eco-head">
        <div class="me-eco-num">01</div>
        <div class="me-eco-head-text">
          <div class="me-eco-kind">VOTRE STACK TECH</div>
      ...
      <div class="me-eco-row">
        <div class="me-eco-tile" data-brand="#FF2D20">
          <div class="me-eco-tile-logo" style="background:#FF2D20">
          ...
          <div class="me-eco-tile-name">Laravel 11 / 12</div>
          <div class="me-eco-tile-sub">Eloquent · Horizon · Pulse · Pennant</div>
        </div>

        <div class="me-eco-tile" data-brand="#0A0A0A">
          <div class="me-eco-tile-logo" style="background:#0A0A0A">
          ...
          <div class="me-eco-tile-name">Next.js 15 / 16</div>
          <div class="me-eco-tile-sub">App Router · RSC · Turbopack · Edge</div>
        </div>

        <div class="me-eco-tile" data-brand="#61DAFB">
          <div class="me-eco-tile-logo" style="background:#61DAFB">
          ...
          <div class="me-eco-tile-name">React 19</div>
          <div class="me-eco-tile-sub">Compiler · Server Components · Suspense</div>
        </div>

        <div class="me-eco-tile" data-brand="#42B883">
          <div class="me-eco-tile-logo" style="background:#42B883">
            <svg viewBox="0 0 24 24" fill="#fff"><path d="M12 2L2 20h6l4-7 4 7h6L12 2z"/></svg>
          </div>
          <div class="me-eco-tile-name">Vue / Nuxt</div>
          <div class="me-eco-tile-sub">Composition API · Pinia · Nuxt 3</div>
        </div>

        <div class="me-eco-tile" data-brand="#9553E9">
          <div class="me-eco-tile-logo" style="background:#9553E9">
          ...
          <div class="me-eco-tile-name">Inertia / Livewire</div>
          <div class="me-eco-tile-sub">SPA sans API séparée · monolith moderne</div>
        </div>

        <div class="me-eco-tile" data-brand="#3776AB">
          <div class="me-eco-tile-logo" style="background:#3776AB">
          ...
          <div class="me-eco-tile-name">Django / Rails</div>
          <div class="me-eco-tile-sub">Legacy ou polyglotte · on reprend aussi</div>
        </div>

        <div class="me-eco-tile" data-brand="#336791">
          <div class="me-eco-tile-logo" style="background:#336791">
          ...
          <div class="me-eco-tile-name">PostgreSQL 16</div>
          <div class="me-eco-tile-sub">Partitioning · WAL · read replicas</div>
        </div>
      </div>
    </article>

    <div class="me-eco-flow" aria-hidden="true">
    ...
    <article class="me-eco-station me-eco-station-core reveal reveal-d-1">
      <div class="me-eco-head">
      ...
      <div class="me-eco-row">
        <div class="me-eco-tile" data-brand="#362D59">
          <div class="me-eco-tile-logo" style="background:#362D59">
            <svg viewBox="0 0 24 24" fill="#fff"><path d="M12 2L2 20h7l3-5 3 5h7L12 2z"/><circle cx="12" cy="15" r="1.5" fill="#362D59"/></svg>
          </div>
          <div class="me-eco-tile-name">Sentry</div>
          <div class="me-eco-tile-sub">Error tracking + performance</div>
        </div>

        <div class="me-eco-tile" data-brand="#E3F0FF">
          <div class="me-eco-tile-logo" style="background:#2563EB">
          ...
          <div class="me-eco-tile-name">Better Stack</div>
          <div class="me-eco-tile-sub">Uptime · statuspage · on-call</div>
        </div>

        <div class="me-eco-tile" data-brand="#F46800">
          <div class="me-eco-tile-logo" style="background:#F46800">
          ...
          <div class="me-eco-tile-name">Grafana Cloud</div>
          <div class="me-eco-tile-sub">Métriques infra + applicatif</div>
        </div>

        <div class="me-eco-tile" data-brand="#1C1C1C">
          <div class="me-eco-tile-logo" style="background:#1C1C1C">
            <svg viewBox="0 0 24 24" fill="#fff"><path d="M4 6h16M4 12h12M4 18h8" stroke="#fff" stroke-width="2" stroke-linecap="round"/></svg>
          </div>
          <div class="me-eco-tile-name">Axiom / Logtail</div>
          <div class="me-eco-tile-sub">Logs structurés · search rapide</div>
        </div>

        <div class="me-eco-tile" data-brand="#4C4A73">
          <div class="me-eco-tile-logo" style="background:#4C4A73">
          ...
          <div class="me-eco-tile-name">Snyk + Dependabot</div>
          <div class="me-eco-tile-sub">SCA · CVE · auto-merge mineurs</div>
        </div>

        <div class="me-eco-tile" data-brand="#06AC38">
          <div class="me-eco-tile-logo" style="background:#06AC38">
          ...
          <div class="me-eco-tile-name">PagerDuty</div>
          <div class="me-eco-tile-sub">Astreinte · escalation · runbooks</div>
        </div>
      </div>
    </article>
    ...
    <article class="me-eco-station reveal reveal-d-2">
      <div class="me-eco-head">
        <div class="me-eco-num">03</div>
        <div class="me-eco-head-text">
      ...
      <div class="me-eco-row">
        <div class="me-eco-tile" data-brand="#4A154B">
          <div class="me-eco-tile-logo" style="background:#4A154B">
        ...
        <div class="me-eco-tile" data-brand="#5E6AD2">
          <div class="me-eco-tile-logo" style="background:#5E6AD2">
          ...
          <div class="me-eco-tile-name">Linear · backlog</div>
          <div class="me-eco-tile-sub">Tickets partagés · roadmap live</div>
        </div>
        ...
        <div class="me-eco-tile" data-brand="#0A0A0A">
          ...
          <div class="me-eco-tile-name">GitHub · repo chez vous</div>
          <div class="me-eco-tile-sub">Org client · Actions · Advanced Security</div>
        </div>

        <div class="me-eco-tile" data-brand="#000000">
          <div class="me-eco-tile-logo" style="background:#191919">
          ...
          <div class="me-eco-tile-name">Notion · docs</div>
          <div class="me-eco-tile-sub">Runbooks · ADR · onboarding</div>
        </div>

        <div class="me-eco-tile" data-brand="#625DF5">
          <div class="me-eco-tile-logo" style="background:#625DF5">
        ...
        <div class="me-eco-tile" data-brand="#2563EB">
          ...
          <div class="me-eco-tile-name">Statuspage publique</div>
          <div class="me-eco-tile-sub">Incidents · uptime · SLA trimestriel</div>
        </div>

        <div class="me-eco-tile" data-brand="#EA4335">
          <div class="me-eco-tile-logo" style="background:#EA4335">
          ...
          <div class="me-eco-tile-name">Rapport mensuel</div>
          <div class="me-eco-tile-sub">PDF board-ready · 15-20 pages</div>
        </div>
      </div>
