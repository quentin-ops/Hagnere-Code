    ...
    <div class="faq-grid">
      ...
      <div class="faq-list reveal reveal-d-1">
        ...
        <div class="faq-item">
          ...
          <div class="faq-a">
            <b>2 à 4 personnes nommées dans votre contrat</b> (photo, prénom, LinkedIn). Pas de rotation, pas de chargé de compte intermédiaire. Binôme obligatoire — jamais un seul dev sur votre projet. Réponse &lt; 2 h HO en Slack. <b>Maximum 8 clients actifs par consultant</b> pour garantir du temps par compte.
          </div>
        </div>
