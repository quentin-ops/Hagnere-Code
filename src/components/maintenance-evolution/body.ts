        ...
        <div class="nav-dd">
          ...
          <div class="dd-col">
            ...
            <a class="dd-link" href="/services/referencement-google">
              ...
              <div class="dd-meta"><div class="dd-title">Publicité en ligne</div><div class="dd-sub">Contenu, tech, netlinking.</div></div>
            </a>
...
<section class="shero">
  ...
  <div class="wrap shero-inner">
    <div>
      <div class="shero-eyebrow"><span class="pill"><span class="dot"></span> Service · Maintenance &amp; évolution · TMA long-terme</span></div>
      <h1>99,98 % d'uptime.<br>14 deploys ce trimestre.<br><span class="accent">0 ticket sans réponse.</span></h1>
      <div class="shero-tagline">
        <span>🛡️ SLA 99,9 % contractuel</span>
        <span class="sep"></span>
        <span>🚀 Deploys hebdo · pas trimestriels</span>
        <span class="sep"></span>
        <span>🔐 CVE patchés sous 48 h</span>
      </div>
      <p class="shero-sub">
        ...
        évolutions continues, hébergement &amp; infra ops. <b>Forfait fixe mensuel, comptes et code chez vous,
        aucun vendor lock-in.</b>
      </p>
      <div class="shero-cta">
