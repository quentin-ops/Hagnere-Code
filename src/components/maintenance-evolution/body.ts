  ...
  <div class="wrap">
    ...
    <div class="caps-grid">
      ...
      <div class="cap reveal reveal-d-3">
        ...
        <p>Lors d'une évolution, nous maintenons les seuls types de données structurées pertinents pour le contenu visible et encore pris en charge. Leur validation technique ne garantit aucun résultat enrichi.</p>
      </div>
      <div class="cap reveal">
  ...
  <div class="wrap">
    ...
    <div class="proc-grid reveal reveal-d-1">
      ...
      <div class="proc-step">
        ...
        <p>Le devis fixe le format du rapport, la durée des réunions, les accès au dashboard et les indicateurs suivis.</p>
        <div class="proc-dur">MENSUEL</div>
      </div>
    </div>
  </div>
      ...
      <div class="reveal">
        ...
        <div class="stack-list">
          ...
          <div class="sl-row">
            ...
            <div class="sl-note">COUVERTURE À DÉFINIR</div>
          </div>
        </div>
      </div>
...
<section class="pricing" id="tarifs">
  <div class="wrap">
    <div class="section-head reveal" style="margin-bottom:0">
      ...
      <div class="right">
        Le devis précise les outils, interventions, livrables, rapports et réunions réellement compris dans le forfait.
    ...
    <p style="text-align:center;margin-top:44px;color:var(--mute);font-size:14px">
      Chaque devis liste les outils, contenus, actions de netlinking, rapports, réunions et ajustements réellement inclus.
    </p>
  </div>
</section>
  ...
  <div class="wrap">
    <div class="faq-grid">
      <div class="faq-intro reveal">
        ...
        <p>Si la vôtre n'y est pas, <a href="#contact" style="color:var(--accent-ink);text-decoration:underline">écrivez-nous</a>. Votre demande est relue personnellement, par un consultant senior, sans détour.</p>
      </div>
      ...
      <div class="faq-list reveal reveal-d-1">
        ...
        <div class="faq-item">
          ...
          <div class="faq-a">
            Le devis précise la durée, le périmètre technique et sémantique, le volume d'analyse, le format du rapport, l'horizon de roadmap, la restitution et toute remise éventuelle.
          </div>
        </div>
      </div>
    </div>
