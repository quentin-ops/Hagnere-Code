...
export const TEAM = {
  quentin: {
    ...
    stack: ["DESIGN", "FRONT-END", "LARAVEL", "FIGMA"],
  ...
  nicolas: {
    ...
    specialty: "Architecture Laravel, choix de stack, jalons techniques, revue de code, compliance.",
    status: "CDI",
    statusLabel: "CTO · CDI",
    basedAt: "Chambéry",
    yearsExp: "10+",
    ...
    stack: ["ARCHITECTURE", "LARAVEL", "MANAGEMENT"],
  ...
  killian: {
    ...
    initials: "KH",
    role: "Senior Dev Laravel",
    roleDetail: "Back-end Laravel + DevOps · Infrastructure",
    ...
    specialty: "Laravel + DevOps, sécurité, scalabilité, CI/CD et tests automatisés.",
    status: "CDI",
    statusLabel: "CDI",
    basedAt: "Chambéry",
    yearsExp: "5+",
    ...
    stack: ["LARAVEL", "DOCKER", "AWS", "FORGE"],
  },
  frederic: {
    id: "frederic",
    firstName: "Frédéric",
    ...
    initials: "FC",
    role: "Senior Dev Laravel",
    roleDetail: "Laravel + Livewire · Temps-réel",
    ...
    specialty: "Laravel + Livewire, formulaires métier, interfaces temps-réel et queues.",
    status: "CDI",
    statusLabel: "CDI",
    basedAt: "Chambéry",
    yearsExp: "5+",
    ...
    stack: ["LARAVEL", "LIVEWIRE", "FLUX UI", "ALPINE.JS"],
  },
  arthur: {
    id: "arthur",
    firstName: "Arthur",
    ...
    initials: "AM",
    role: "Senior Dev Back-end Laravel",
    ...
    specialty: "Architecture Laravel, systèmes complexes, paiements et facturation.",
    status: "freelance",
    ...
    stack: ["LARAVEL", "STRIPE", "MySQL", "PENNYLANE"],
  },
  ryan: {
    id: "ryan",
    firstName: "Ryan",
    ...
    initials: "RM",
    role: "Senior Dev Laravel",
    roleDetail: "Laravel + IA · Agents Claude",
    ...
    specialty: "Laravel + intégrations IA, agents Claude, webhooks et APIs tierces.",
    status: "freelance",
    statusLabel: "Freelance long-terme",
    basedAt: "France",
    yearsExp: "5+",
    ...
    stack: ["LARAVEL", "CLAUDE", "PRISM", "PGVECTOR"],
  },
  peter: {
    id: "peter",
    firstName: "Peter",
    ...
    initials: "PS",
    role: "Dev confirmé Back-end Laravel",
    roleDetail: "Full-stack PHP / Laravel / Symfony · React / Vue.js",
    ...
    specialty: "Renforts API Laravel/Symfony, modélisation BDD, intégrations, front React/Vue.",
    status: "freelance",
    statusLabel: "Freelance long-terme",
    basedAt: "France",
    yearsExp: "3+",
    ...
    stack: ["PHP", "LARAVEL", "SYMFONY", "REACT", "VUE.JS"],
  },
