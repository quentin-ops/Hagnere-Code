...
export const GUIDES: GuideEntry[] = [
  ...
  },
  {
    ...
    title: "Prix gestion Google Ads : comparer 4 modèles en 2026",
    cardTitle: "Prix d’une gestion Google Ads",
    metaDescription:
      "Comparez forfait, pourcentage, hybride et temps passé avec le coût média, la TVA, les frais annexes et votre temps sur 3, 6 et 12 mois.",
    cardDescription:
    ...
    datePublished: "2026-07-30T07:33:18+02:00",
    dateModified: "2026-07-30T07:33:18+02:00",
    readTimeMin: 22,
    articleImagePaths: [
